...
ye_sim <- purrr::map_dfr(c("HBLL OUT N", "HBLL OUT S", "HBLL INS N"), ~{
  load_sim_data("yelloweye rockfish", .x, 1.021, "fitted_AR1", "twenty-five_years", sim_summary, sim_dir, replicates = 1)
})
...
FILTER_SPECIES <- c("silvergray rockfish", "yelloweye rockfish")
FILTER_SURVEY <- NULL
